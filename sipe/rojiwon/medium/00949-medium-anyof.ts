...
type Truely<T> = Equal<T, 0> extends true ? false
  : Equal<T, ''> extends true ? false
    : Equal<T, false> extends true ? false
      : Equal<T, []> extends true ? false
        : Equal<T, {}> extends true ? false
          : Equal<T, undefined> extends true ? false
            : Equal<T, null> extends true ? false
              : true

type AnyOf<T extends readonly any[]> =
   T extends [infer Head, ...infer Rest]
     ? Truely<Head> extends true
       ? true
       : AnyOf<Rest>
     : false
