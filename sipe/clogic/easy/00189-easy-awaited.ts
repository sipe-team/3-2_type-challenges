...
type PromiseFunc<T> = { then(onfulfilled: T, ...args: any): any }
type OnFulfilledFunc<T> = (value: T, ...args: any) => any

type MyAwaited<T> = T extends null | undefined
  ? T
  : (T extends PromiseFunc<infer F>
      ? (F extends OnFulfilledFunc<infer V>
          ? MyAwaited<V>
          : never)
      : T)
